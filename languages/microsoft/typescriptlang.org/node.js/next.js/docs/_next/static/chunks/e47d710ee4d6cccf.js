(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		let n = e.r(2879)._(e.r(6960)).default.createContext(null);
	},
	9594,
	(e, t, r) => {
		'use strict';
		...
		(() => {
			...
			'undefined' != typeof __nccwpck_require__ &&
				(__nccwpck_require__.ab =
					'/ROOT/node_modules/.pnpm/next@15.5.4_@babel+core@7.28.0_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/path-to-regexp/');
			var e = {};
			((() => {
				function t(e, t) {
					void 0 === t && (t = {});
						...
						var r = (function (e) {
								for (var t = [], r = 0; r < e.length; ) {
									...
									if ('(' === n) {
										...
										(t.push({ type: 'PATTERN', index: r, value: c }), (r = a));
										continue;
									}
					...
					return function (t) {
						for (var r = '', n = 0; n < e.length; n++) {
							...
							if (!s) {
								...
								throw TypeError(
									'Expected "'.concat(a.name, '" to be ').concat(d),
								);
							}
						}
						return r;
				...
				function n(e, t, r) {
					...
					return function (r) {
						...
						if (!n) return !1;
						for (
							var a = n[0], i = n.index, u = Object.create(null), c = 1;
							c < n.length;
							c++
						)
							!(function (e) {
				...
				function i(e, t, r) {
					...
					for (
						var n = r.strict,
							...
							f = r.delimiter,
							p = r.endsWith,
							d = '['.concat(o(void 0 === p ? '' : p), ']|$'),
							_ = '['.concat(o(void 0 === f ? '/#?' : f), ']'),
							h = void 0 === u || u ? '^' : '',
							m = 0;
						m < e.length;
						m++
						...
						if ('string' == typeof E) h += o(l(E));
							...
							if (E.pattern)
								if ((t && t.push(E), g || R))
									...
									h += '('.concat(E.pattern, ')').concat(E.modifier);
								}
							else h += '(?:'.concat(g).concat(R, ')').concat(E.modifier);
						}
					}
					if (void 0 === c || c)
						(i || (h += ''.concat(_, '?')),
							(h += r.endsWith ? '(?='.concat(d, ')') : '$'));
					else {
						var b = e[e.length - 1],
							y =
								'string' == typeof b
									? _.indexOf(b[b.length - 1]) > -1
									: void 0 === b;
						(i || (h += '(?:'.concat(_, '(?=').concat(d, '))?')),
							y || (h += '(?='.concat(_, '|').concat(d, ')')));
					}
					return new RegExp(h, a(r));
				}
				function u(e, r, n) {
	...
	(e, t, r) => {
		...
		function u(e) {
			...
			for (let [r, o] of Object.entries(e))
				'string' == typeof o
					? (t[r] = o.replace(new RegExp('^'.concat(n)), ''))
					: Array.isArray(o)
						? (t[r] = o.map((e) =>
								'string' == typeof e
		...
		function a(e) {
			...
			return (0, o.safeRouteMatcher)((e) => {
				...
				for (let [e, t] of Object.entries(r)) {
					let r = o[t.pos];
					void 0 !== r &&
						(t.repeat ? (i[e] = r.split('/').map((e) => a(e))) : (i[e] = a(r)));
				}
				return i;
			});
		}
	...
	(e, t, r) => {
		...
		function c(e, t, r) {
			let n = {},
				c = 1,
				s = [];
			for (let l of (0, i.removeTrailingSlash)(e).slice(1).split('/')) {
				let e = o.INTERCEPTION_ROUTE_MARKERS.find((e) => l.startsWith(e)),
					i = l.match(u.PARAMETER_PATTERN);
				if (e && i && i[2]) {
					let {
						key: t,
						optional: r,
					...
					((n[e] = { pos: c++, repeat: t, optional: o }),
						r && i[1] && s.push('/' + (0, a.escapeStringRegexp)(i[1])));
					let l = t ? (o ? '(?:/(.+?))?' : '/(.+?)') : '/([^/]+?)';
					(r && i[1] && (l = l.substring(1)), s.push(l));
				} else s.push('/' + (0, a.escapeStringRegexp)(l));
		...
		function l(e) {
			let t,
				...
				{ key: l, optional: f, repeat: p } = (0, u.parseMatchedParameter)(o),
				d = l.replace(/\W/g, '');
			c && (d = '' + c + d);
			let _ = !1;
		...
		function f(e, t, r, c, s) {
			...
			for (let f of (0, i.removeTrailingSlash)(e).slice(1).split('/')) {
				...
				if (e && i && i[2])
					...
					c && i[1] && _.push('/' + (0, a.escapeStringRegexp)(i[1]));
					let e = l({
						getSafeRouteKey: p,
						segment: i[2],
						routeKeys: d,
					...
					(c && i[1] && (e = e.substring(1)), _.push(e));
				} else _.push('/' + (0, a.escapeStringRegexp)(f));
				r && i && i[3] && _.push((0, a.escapeStringRegexp)(i[3]));
			}
	...
	(e, t, r) => {
		...
		let n = e.r(3621);
		function o(e) {
			return (0, n.pathHasPrefix)(e, '/chess');
		}
		('function' == typeof r.default ||
			('object' == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
	...
	(e, t, r) => {
		...
		function d(e, t, r) {
			let d,
				_ = 'string' == typeof t ? t : (0, o.formatWithValidation)(t),
				h = _.match(/^[a-z][a-z0-9+.-]*:\/\//i),
				m = h ? _.slice(h[0].length) : _;
			...
			if (!(0, c.isLocalURL)(_)) return r ? [_] : _;
			try {
				let t = _.startsWith('#') ? e.asPath : e.pathname;
				if (
					_.startsWith('?') &&
