...
const content = {
  landing: {
    hero: {
      ...
      tagline:
        "Securely route and manage external API calls through a single, unified gateway.",
    ...
    features: [
      {
        ...
        description:
          "Hide sensitive API keys and manage requests with confidence.",
      },
      {
        title: "Flexible Proxying",
        description:
          "Support GET, POST, and other methods with full header and body forwarding.",
      },
      {
        title: "Developer Friendly",
        description:
          "Clear documentation and quick setup to get your proxy up and running fast.",
      },
    ],
    callToAction: {
